...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for testing prompting of the HBNB cmd interpret."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for testing help messages of the HBNB cmd interpret."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for testing exiting from the HBNB cmd interpret."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for testing create from the HBNB cmd interpret."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for testing show from the HBNB cmd interpret"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for testing destroy from the HBNB cmd interpret."""
