#!/usr/bin/python3
"""Defines unit tests for the City class in models/city.py.
Unittest classes:
...
class TestCity_save(unittest.TestCase):
    """Unit tests for the save method in the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unit tests for the to_dict method in the City class."""
